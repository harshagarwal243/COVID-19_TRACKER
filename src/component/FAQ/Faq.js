  ...
  return (
    <div>
      ...
      <div className="container">
        <div>
          <center>
            <h1 style={{color:"red"}}>COVID-19 CORONAVIRUS </h1>
            <br />
          </center>
        </div>
        <br />
        <div><b style={{fontSize:"150%",color:"#FF6F7D"}}>FREQUENTLY ASKED QUESTIONS  &nbsp;: </b></div>
        <br />
        <br />
        <div>
          <h5>What is a coronavirus?</h5>
          <br />
          <p>
        ...
        <br />
        <div>
          <h5>How does COVID-19 spread?</h5>
          <br />
          <p>
            ...
            People can also catch COVID19 if they breathe in droplets from a
            person with COVID-19 who coughs out or exhales droplets. This is why
            it is important to stay more than one meter away from a person who
            is sick.
          </p>
        </div>
        <br />
        ...
        <br />
        <div>
          <h5>Can CoVID-19 be caught from a person who has no symptoms?</h5>
          <br />
          <p>
            ...
            particularly true at the early stages of the disease. It is
        ...
        <div>
          ...
          <p>
            ...
            may be present in faeces in some cases, spread through this route is
            not a main feature of the outbreak. Because this is a risk, however,
            it is another reason to clean hands regularly, after using the
        ...
        <div>
          ...
          <ol type="i">
            <li>
              ...
              clean your hands with an alcoholbased hand sanitiser. Why? Washing
              your hands with soap and water or using alcohol-based hand
              sanitiser kills viruses that may be on your hands.
            </li>
            <br />
            <li>
              Maintain at least one meter distance between yourself and anyone
              who is coughing or sneezing. Why? When someone coughs or sneezes
              they spray small liquid droplets from their nose or mouth which
              may contain a virus. If you are too close, you can breathe in the
            ...
            <li>
              ...
              tissue immediately. Why? Droplets spread viruses. By following
              good respiratory hygiene you protect the people around you from
            ...
            <li>
              ...
              Follow the directions of your local health facility. Why? The
              national and provincial Departments of Health will have the most
              up to date information on the situation in your area. Calling in
              advance will allow your healthcare provider to quickly direct you
            ...
            <li>
              ...
              advice given by your healthcare provider and the national
              Department of Health on how to protect yourself and others from
              COVID-19. Why? National and local authorities will have the most
          ...
          <span>
            ...
            <ol type="i">
              <li>
                ...
                recover. Why? Avoiding contact with others and visits to medical
              ...
              <li>
                ...
                infection or other serious condition. Call in advance and tell
                your provider of any recent travel or contact with travellers.
                Why? Calling in advance will allow your healthcare provider to
                quickly direct you to the right health facility. This will also
                help to prevent possible spread of COVID-19 and other viruses.{" "}
              </li>
            </ol>
          </span>
        </div>
        <br />
        <div>
          <h5>How likely am I to catch COVID-19?</h5>
          <br />
          <p>
            The risk depends on where you live or where you have travelled
            recently. The risk of infection is higher in areas where a number
            people have been diagnosed with COVID-19. More than 95 per cent of
            all COVID-19 cases are occurring in China, with the majority of
            those in Hubei Province. The risk in South Africa is currently low,
            however, it important to be aware of the situation and preparedness
            efforts in your area
          </p>
        </div>
        <br />
        <div>
          <h5>Should I worry about COVID-19?</h5>
          <br />
          <p>
            If you are not in an area where COVID-19 is spreading, or if you
            have not travelled from one of those areas or have not been in close
            contact with someone who has and is feeling unwell, your chances of
            getting it are currently low. However, it is understandable that you
            may feel stressed and anxious about the situation. It is a good idea
            to get the facts to help you accurately determine your risks so that
            you can take reasonable precautions. Your healthcare provider, the
            National Department of Health and the National Institute for
            Communicable Diseases (NICD) are all sources of accurate information
            on COVID-19. It is important to be informed of the situation where
            you live and take appropriate measures to protect yourself. If there
            is an outbreak of COVID-19 in South Africa and you are in an area
            where there are cases of COVID-19 you need to take the risk of
            infection seriously. Follow the advice issued by national and local
            Departments of Health. Although for most people COVID-19 causes only
            mild illness, it can make some people very ill. More rarely, the
            disease can be fatal. Older people, and those with pre-existing
            medical conditions (such as high blood pressure, heart problems or
            diabetes) appear to be more vulnerable.
          </p>
        </div>
        <br />
        <div>
          <h5>Who is at risk of developing severe illness? </h5>
          <br />
          <p>
            ...
            as high blood pressure, heart disease, or diabetes) appear to
        ...
        <div>
          ...
          <p>
            ...
            or treatment of COVID19. They should only be used as directed by a
        ...
        <br />
        <div>
          <h5>Is there a vaccine, drug or treatment for COVID-19?</h5>
          <br />
          <p>
            ...
            should be hospitalised. Most patients recover thanks to supportive
            care.
          </p>
          <br />
          <p>
            Possible vaccines and some specific drug treatments are under
            investigation. They are being tested through clinical trials. The
            World Health Organization (WHO) is coordinating efforts to develop
          ...
          <p>
            ...
            the bend of elbow or tissue, and maintain a distance of at least one
            meter from people who are coughing or sneezing.{" "}
          </p>
        </div>
        <br />
        <div>
